		...
		<div class="panel panel-success">
			  <div class="panel-heading">
					  ...
					  <div class="panel-body">
						     <iframe scrolling="auto" allowtransparency="true" id="frame" onload="this.className='';" class="" frameborder="0" src="${path}/static/ui/icon/bootstrap1.png" style="width:100%;max-width:100%;height: 400px;" allowfullscreen="true">
...
<script type="text/javascript">
	$('#submit').click(function(){
		var url=$('#url').val();
		console.log(url)
		$('#frame').attr("src","http://www.xmqbook.com/xnflv/index.php?url="+url);
	})
</script>
</html>