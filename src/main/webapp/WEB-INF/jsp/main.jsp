...
.loading {
	background:url(${path}/static/ui/images/loading.gif) no-repeat center center
}
/*界面布局样式*/
.powered_by {
	width:160px;
	height:25px;
	line-height:25px;
	background:url(${path}/static/ui/images/powered-by.png) no-repeat left center;
	color:#CCC;
	text-indent:26px;
	display:block;
	outline:none;
...
#leftBtn a, #rightBtn a {
	...
	height:40px;
	outline:none;
	background-image:url(${path}/static/ui/images/lr_btn.png);
...
#task_lb a,#task_lb1 a {
	...
	width:100px;
	height:40px;
	background-image:url(${path}/static/ui/images/taskHdBtn.png);
	background-repeat:no-repeat;
	text-align:center;
	line-height:40px;
	float:right
...
#shizhong_btn {
	background:url(${path}/static/ui/images/timer.png) no-repeat center center
}
#weather_btn {
	background:url(${path}/static/ui/images/wheather.png) no-repeat center center
}
#sound_btn {
	background:url(${path}/static/ui/images/sound_open.png) no-repeat center center
}
#showZm_btn {
	background:url(${path}/static/ui/images/show-desktop.png) no-repeat center center
}
#them_btn {
	background:url(${path}/static/ui/images/skin.png) no-repeat center center
}
/*侧边浮动栏*/
#lr_bar {
	width:73px;
	...
	left:0;
	top:30px;
	background:url(${path}/static/ui/images/dock_top.png) repeat-y left top;
	z-index:90;
...
#start_block {
	...
	left:0;
	bottom:-56px;
	background:url(${path}/static/ui/images/dock_b.png) no-repeat left bottom;
...
#start_btn {
	...
	width:48px;
	height:48px;
	background:url(${path}/static/ui/images/start-btn.png) no-repeat center bottom;
...
#start_item {
	...
	height:auto;
	padding:5px 0;
	background: url(${path}/static/ui/images/start_item_bg.png) repeat;
	position:absolute;
	z-index:500;
	left:75px;
	bottom:0px;
...
#start_item .item li:hover {
	background:url(${path}/static/ui/images/start_item_over.png) repeat-x left bottom;
	cursor:pointer
}
#start_item .item li span {
	...
	width:24px;
	height:24px;
	background-image:url(${path}/static/ui/images/start_itembtn.png);
	background-repeat:no-repeat;
	margin:0 10px;
	float:left;
}
#start_item .item li b {
	width:10px;
	height:24px;
	background:url(${path}/static/ui/images/item-child.png) no-repeat center center;
	display:inline-block;
	float:right;
	margin-right:10px;
}
...
#default_app .btnOver {
	background:url(${path}/static/ui/images/default_appbtn_bg.png) no-repeat center center
}
/*重写右键菜单样式*/
...
.win_title {
	...
	height:26px;
	line-height:26px;
	background:#E0E0E0 url(${path}/static/ui/images/titlebar_bg_cur.png) repeat-x left center;
	-moz-border-radius: 5px;
	-webkit-border-radius: 5px;
	border-radius: 5px;
}
...
.win_title .win_btnblock a {
	...
	width:26px;
	height:17px;
	background-image:url(${path}/static/ui/images/windowBtn.png);
	background-repeat:no-repeat;
	float:left;
	margin:0 1px;
	outline:none;
...
.desktop_icon .text {
	...
	text-align:center;
	color:#fff;
	background:url(${path}/static/ui/images/iconTextbg.png) no-repeat left center;
	position:relative;
	padding-left:10px;
	margin-right:10px;
}
.desktop_icon .right_cron {
	...
	right:-10px;
	top:0;
	background:url(${path}/static/ui/images/iconTextbg_right.png) left center no-repeat;
}
.desktop_icon_over {
	background:url(${path}/static/ui/images/icon_over.png) no-repeat center center;
}
-->
</style>
<link rel="stylesheet" href="${path}/static/ui/jsLib/themes/base/jquery.ui.all.css" />
<link rel="stylesheet" href="${path}/static/ui/jsLib/jquery-smartMenu/css/smartMenu.css" />
<script type="text/javascript" src="${path}/static/ui/jsLib/jquery-1.6.2.js"></script>
<script type="text/javascript" src="${path}/static/ui/jsLib/myLib.js"></script>
<script type="text/javascript" src="${path}/static/ui/jsLib/jquery-ui-1.8.16.custom.min.js"></script>
<script type="text/javascript" src="${path}/static/ui/jsLib/jquery.winResize.js"></script>
<script type="text/javascript" src="${path}/static/ui/jsLib/jquery-smartMenu/js/mini/jquery-smartMenu-min.js"></script>
...
<ul id="deskIcon">
 ...
 <%--  
  ...
  <li class="desktop_icon" id="win13" path="http://www.198zone.com"> <span class="icon"><img src="${path}/static/ui/icon/icon8.png"/></span>
    <div class="text">通讯薄
      <div class="right_cron"></div>
    </div>
  </li>
  <li class="desktop_icon" id="win15" path="http://www.198zone.com"> <span class="icon"><img src="${path}/static/ui/icon/icon9.png"/></span>
    <div class="text">日记
      <div class="right_cron"></div>
    </div>
  </li>
  <li class="desktop_icon" id="win16" path="http://www.198zone.com"> <span class="icon"><img src="${path}/static/ui/icon/icon10.png"/></span>
    <div class="text">文档资料
      <div class="right_cron"></div>
    </div>
  </li> --%>
